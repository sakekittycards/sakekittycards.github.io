...
- **Trade-in tiers (Option B — unified $100/$500/$1,000 breakpoints).** Codified in `trade-in.html` `RATES` const + matrix panel.
  - **Singles**: <$100 60/70 · $100–$499 70/80 · $500–$999 75/85 · ≥$1,000 80/90
  - **Sealed**:  <$100 60/70 · $100–$499 70/80 · $500–$999 75/85 · ≥$1,000 80/90
  - **Graded**:  <$100 NOT ACCEPTED · $100–$499 70/80 · $500–$999 75/85 · ≥$1,000 80/90
  - Graded under $100 isn't accepted — slab cost ($25-30 for grading) outweighs the card. Matrix shows ✕ in that cell with footnote explanation. Form falls through to singles `RATES.base` (60/70) if a low-value graded card is added so quotes stay sane even when the policy guidance is bypassed. All other graded bands now match singles/sealed exactly (no +2-5pt bump — that was Nick's earlier preference but rejected 2026-05-06). 80% cash hard cap at $1,000+. Trade credit = cash + 10pts. Headline banner reads "Up to 80% cash · 90% trade credit". Rates dropped 10pts across the board 2026-05-12.
