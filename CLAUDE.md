...
- **Trade-in tiers (Option A — finer granularity, smoother $-cliffs).** Codified in `trade-in.html` `RATES` const and the rate-card panel.
  - **Raw singles** by market value: <$25 60/70 · $25–$99 72/82 · $100–$299 80/90 · $300–$749 85/95 · ≥$750 90/100
  - **Sealed**: modern <$300 75/85 · premium ≥$300 85/95
  - **Graded**: <$250 75/85 · $250–$749 82/92 · $750–$1,999 87/97 · ≥$2,000 90/100 (cash capped at 90% per Nick — same as singles top tier)
  - Trade credit follows cash + 10pts on every tier. Updated 2026-05-05 evening from the previous 4-tier singles + flat sealed schedule (the <$100 single-bucket was lumping a $4 RH with a $90 chase). Bottom singles label is "Non-bulk Singles under $25". Headline banner reads "Up to 90% cash · 100% trade credit". Top tier (Singles ≥$750 + Graded ≥$2,000) shares the 90/100 rate.
