...
- **Trade-in tiers (Option B — unified $100/$500/$1,000 breakpoints across all types).** Codified in `trade-in.html` `RATES` const and the rate-card panel.
  - **Raw singles**: <$100 70/80 · $100–$499 80/90 · $500–$999 85/95 · ≥$1,000 90/100
  - **Sealed**: <$100 70/80 · $100–$499 80/90 · $500–$999 85/95 · ≥$1,000 90/100
  - **Graded** (gets +2-5pt bump in mid bands for slab sale-certainty): <$100 75/85 · $100–$499 82/92 · $500–$999 87/97 · ≥$1,000 90/100
  - All types cap at 90/100 at $1,000+ (Nick's hard ceiling on cash). Trade credit = cash + 10pts. Updated 2026-05-05 evening: dropped the original <$25 60/70 micro tier — anything under $100 is a flat 70/80 (singles+sealed) or 75/85 (graded). Headline banner reads "Up to 90% cash · 100% trade credit".
