...
- **Trade-in tiers (Option B — unified $100/$500/$1,000 breakpoints).** Codified in `trade-in.html` `RATES` const + matrix panel.
  ...
  - **Sealed**:  <$100 70/80 · $100–$499 80/90 · $500–$999 85/95 · ≥$1,000 90/100
  - **Graded**:  <$100 NOT ACCEPTED · $100–$499 80/90 · $500–$999 85/95 · ≥$1,000 90/100
  - Graded under $100 isn't accepted — slab cost ($25-30 for grading) outweighs the card. Matrix shows ✕ in that cell with footnote explanation. Form falls through to singles `RATES.base` (70/80) if a low-value graded card is added so quotes stay sane even when the policy guidance is bypassed. All other graded bands now match singles/sealed exactly (no +2-5pt bump — that was Nick's earlier preference but rejected 2026-05-06). 90% cash hard cap at $1,000+. Trade credit = cash + 10pts. Headline banner reads "Up to 90% cash · 100% trade credit".
