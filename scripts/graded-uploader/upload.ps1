# Wrapper to run upload_to_square.py with the admin token sourced from a
...
python upload_to_square.py
$exit = $LASTEXITCODE

# Wipe the env var so it doesn't linger for the rest of the session.
